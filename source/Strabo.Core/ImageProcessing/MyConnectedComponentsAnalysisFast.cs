...
namespace Strabo.Core.ImageProcessing
{
    public class MyConnectedComponentsAnalysisFast
    {
        public class MyBlob
        {
            ...
            public int area;
            public int pixel_id;
            public List<int> string_id_list = new List<int>();
            ...
            public double[] mean_shift_results = new double[4];
            public double[] mean_shift_results2 = new double[4];
        ...
        public class MyBlobCounter
        {
            ...
            public void Process(Bitmap srcImg)
            {
