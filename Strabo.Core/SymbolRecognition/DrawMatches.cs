...
namespace Strabo.Core.SymbolRecognition
{
    ...
    {
        public static Tuple<Image<Bgr, byte>, HomographyMatrix> DrawHomography(Image<Gray, byte> model, Image<Gray, byte> observed, double uniquenessThreshold)
        {
        ...
        public static Tuple<Image<Bgr, Byte>, float[]> Draw(Image<Gray, byte> modelImage, Image<Gray, byte> observedImage, Image<Bgr, byte> modifiedImage, int x0, int y0, string path, string topic, int counter, TextWriter log)
        {
            ...
            try
            {
                ...
                homo1 = DrawHomography(modelImage, observedImage, 0.5);
            }
            catch (Exception)
            {
